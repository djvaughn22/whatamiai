...
export default function WhatAmIAIPage() {
  ...
  const themeBtn = (
    <button
      ...
      style={{ background: "none", border: `1px solid ${border}`, borderRadius: 50, padding: "5px 12px", fontSize: 12, cursor: "pointer", color: sub }}
    >
      {dark ? "☀️" : "🌙"}
    </button>
  );
    ...
    return (
      <main style={shell}>
        <div style={{ maxWidth: 640, margin: "0 auto", padding: "36px 24px 80px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 56, paddingBottom: 18, borderBottom: `1px solid ${border}` }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            <h1 style={{ fontSize: 46, fontWeight: 900, color: text, margin: "0 0 16px", lineHeight: 1.05 }}>WhatAmIAI</h1>
            <p style={{ fontSize: 19, color: sub, lineHeight: 1.7, maxWidth: 460, margin: "0 auto 32px" }}>
